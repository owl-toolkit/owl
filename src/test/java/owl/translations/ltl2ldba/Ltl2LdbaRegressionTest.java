...
public class Ltl2LdbaRegressionTest {
  ...
  static void testOutput(String ltl, int size) throws IOException {
    ...
    LimitDeterministicAutomaton<InitialComponentState, AcceptingComponent.State, BuchiAcceptance, InitialComponent<AcceptingComponent.State, RecurringObligations>, AcceptingComponent> automaton = translation
