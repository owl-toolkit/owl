...
public final class LanguageContainment {
   ...
   * second automaton.
   *
   * @param automaton1 The first automaton, whose language is tested for inclusion in the second
   *                   language
  ...
  public static boolean containsCoBuchi(
    ...
    return contains(
        automaton1, Views.dropStateLabels(
            Determinization.determinizeCoBuchiAcceptance(automaton2)).automaton());
  }
  ...
  public static boolean containsAll(
    ...
    return contains(automaton1, Views.dropStateLabels(
        Determinization.determinizeAllAcceptance(automaton2)).automaton());
  }
