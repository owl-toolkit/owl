...
public class ImplicitNonDeterministicEdgesAutomaton<S, A extends OmegaAcceptance>
  ...
  private final BiFunction<S, BitSet, Set<Edge<S>>> edgeFunction;

  public ImplicitNonDeterministicEdgesAutomaton(ValuationSetFactory factory,
    Collection<S> initialStates, A acceptance, BiFunction<S, BitSet, Set<Edge<S>>> edgeFunction) {
  ...
  public Set<Edge<S>> edges(S state, BitSet valuation) {
    ...
    return edgeFunction.apply(state, valuation);
  }
}
