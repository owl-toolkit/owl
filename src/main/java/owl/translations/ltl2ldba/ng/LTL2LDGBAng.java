...
public class LTL2LDGBAng extends LTL2LDBATemplate<State,
  GeneralizedBuchiAcceptance, RecurringObligations2, GeneralizedAcceptingComponent> {
  ...
  @Override
  protected InitialComponent<GeneralizedAcceptingComponent.State, RecurringObligations2>
  createInitialComponent(Factories factories, GeneralizedAcceptingComponent acceptingComponent) {
    RecurringObligations2Selector recurringObligationsSelector =
      new RecurringObligations2Selector(optimisations, factories.equivalenceClassFactory);
