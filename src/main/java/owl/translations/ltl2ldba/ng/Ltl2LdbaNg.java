...
public class Ltl2LdbaNg extends
  Ltl2LdbaTemplate<AcceptingComponent.State, BuchiAcceptance, RecurringObligations2, AcceptingComponent> {
  ...
  @Override
  protected InitialComponent<AcceptingComponent.State, RecurringObligations2> createInitialComponent(
