...
import owl.translations.ltl2ldba.GeneralizedAcceptingComponent.State;
import owl.translations.ltl2ldba.ng.NondetInitialComponent;

public class LTL2LDGBA extends LTL2LDBATemplate<State,
  GeneralizedBuchiAcceptance, RecurringObligations, GeneralizedAcceptingComponent> {
  ...
  @Override
  protected InitialComponent<GeneralizedAcceptingComponent.State, RecurringObligations>
