...
public class GeneralisedAcceptingComponent extends
  AbstractAcceptingComponent<GeneralisedAcceptingComponent.State, GeneralisedBuchiAcceptance, RecurringObligations> {
  ...
  public final class State extends ImmutableObject
    implements AutomatonState<GeneralisedAcceptingComponent.State> {
