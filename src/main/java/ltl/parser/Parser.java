...
public class Parser implements ParserConstants {
  ...
  final public Formula binaryOp() throws ParseException {
    Formula left;
    Formula right;
    left = unaryOp();
    if (jj_2_31(2)) {
      if (jj_2_24(2)) {
        ...
        right = unaryOp();
        left = Conjunction
          .create(Disjunction.create(left.not(), right), Disjunction.create(left, right.not()));
      } else if (jj_2_26(2)) {
  ...
  final public Comparison comp() throws ParseException {
    if (jj_2_44(2)) {
  ...
  final public Formula formulaEmbedded() throws ParseException {
    Formula f;
    f = disjunction();
  ...
  final public TLSF tlsf() throws ParseException {
