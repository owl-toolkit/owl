...
if (op != null) {
                ...
                {if ("" != null) return new FrequencyG(f, bound, comp, limes);}
            }
...
{if ("" != null) return Comparison.GEQ;}
    } else if (jj_2_45(2)) {
      jj_consume_token(GT);
{if ("" != null) return Comparison.GT;}
    } else if (jj_2_46(2)) {
      jj_consume_token(LEQ);
{if ("" != null) return Comparison.LEQ;}
    } else if (jj_2_47(2)) {
      jj_consume_token(LT);
{if ("" != null) return Comparison.LT;}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
