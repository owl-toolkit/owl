...
class ImplicationVisitor implements BinaryVisitor<Boolean, Formula> {
  ...
  public Boolean visit(GOperator g, Formula fo) {
    ...
    if (fo instanceof FOperator || fo instanceof GOperator) {
      return g.operand.accept(this, ((UnaryModalOperator) fo).operand) || g
        .accept(this, ((UnaryModalOperator) fo).operand);
    }
    ...
    if (fo instanceof UOperator) {
      return g.accept(this, ((UOperator) fo).right) || g.accept(this,
        new Conjunction(new GOperator(((UOperator) fo).left),
          new FOperator(((UOperator) fo).right)));
    }
  ...
  public Boolean visit(UOperator u, Formula fo) {
    ...
    if (fo instanceof UOperator) {
      return
        u.left.accept(this, ((UOperator) fo).left) && u.right.accept(this, ((UOperator) fo).right)
    ...
    return Simplifier.simplify(new Disjunction(u.left, u.right), Simplifier.Strategy.AGGRESSIVELY)
      .accept(this, fo);
  }
  ...
  public Boolean visit(ROperator r, Formula fo) {
    ...
    if (fo instanceof ROperator) {
      return r.left.accept(this, ((ROperator) fo).left) && r.right
        .accept(this, ((ROperator) fo).right);
    }
